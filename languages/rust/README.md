...
3. [The Rust Programming Language](https://web.mit.edu/rust-lang_v1.25/arch/amd64_ubuntu1404/share/doc/rust/html/book/second-edition/ch01-00-introduction.html)
4. [Rust by Practice](https://practice.rs/why-exercise.html)
5. [Embedded Rust](https://docs.rust-embedded.org/book/)
6. [Learn Rust Programming - Complete Course 🦀](https://youtu.be/BpPEoZW5IiY?si=JhMrIwiK4_go8gcB)
7. [The Algorithms: Rust](https://github.com/TheAlgorithms/Rust)
