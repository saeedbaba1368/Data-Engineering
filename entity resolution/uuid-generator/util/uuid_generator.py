...
class uuidGenerator:
    ...
    def remove_punctuation(self,input_string:str) -> str:
        return u''.join([ch for ch in input_string if ch not in set(string.punctuation)])
    ...
    def remove_stopwords(
        self,input_string:str, stopwords: nltk.corpus.reader.wordlist.WordListCorpusReader = stopwords.words("english")
    ) -> str:
        return u' '.join(
