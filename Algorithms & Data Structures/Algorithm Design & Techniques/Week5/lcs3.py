...
def edit_distance(s, t): # Please read edit_distance.py for explanation
    ...
    i, j = len(s), len(t)
    count, common, subsequence = 0, 0, list() # subsequence to contain the matched sequence in reversed order
...
def lcs3(a, b, c):
    ...
    common_ab, subseq_ab = edit_distance(a, b) # Longest common sequence between a and b (edit distance to transform a to b)
    common_ba, subseq_ba = edit_distance(b, a) # Longest common sequence between b and a (edit distance to transform b to a)
    common_cab, subseq_cab = edit_distance(c, subseq_ab) # Longest common sequence between c and lcs(a, b)
    common_cba, subseq_cba = edit_distance(c, subseq_ba) # Longest common sequence between c and lcs(b, a)
