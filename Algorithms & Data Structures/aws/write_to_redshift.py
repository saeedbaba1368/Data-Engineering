...
for table in tables:
    ...
    data.write \
        .format("com.databricks.spark.redshift") \
        .option("url", "jdbc:redshift://dest_redshift_host:port/dest_database") \
        .option("tempdir", "s3n://dest_temp-bucket/temp-dir") \
        .option("dbtable", table) \
        .option("forward_spark_s3_credentials", "true") \
