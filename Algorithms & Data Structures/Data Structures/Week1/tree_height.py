...
def fast_compute_height(n, parents): # It takes O(n) because there are two for-loops
    ...
    for i in range(n):
        ...
        t_node.parent = parents[i] # parents is a given array, parents[index] return the parent of child with key index
        if t_node.parent == -1: # If parents[index] == -1, then this node is the root of the tree
            t.root = t_node
    ...
    return get_height(t, t.root) + 1 # At last, the tree is passed to standard implementation of tree height function
