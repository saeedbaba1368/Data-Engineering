...
try:
    ...
    with st.expander("ANALYTICS"):
        ...
        a1.metric(
            ...
            value=items,
            help=f""" Total Price: {total_price} """,
            delta=total_price,
        )
        a2.metric(
            label="Total Price",
    ...
    def add_google_maps(m):
        ...
        folium.TileLayer(
            tiles=tiles, attr=attr, name=attr, overlay=True, control=True
        ).add_to(m)
    ...
    with col2:
        ...
        fig.update_traces(
            hole=0.4
        )  # Set the size of the hole in the middle for a donut chart
