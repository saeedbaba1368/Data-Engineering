...
if __name__ == "__main__":
    text = """
        Ceci est une réponse à Saizai - j'espère que je le prononce correctement - qui me demande ce que je croyais quand j'étais théiste et ce que je crois maintenant. 
        Je pourrais répondre à ces questions en quelques secondes - ou quelques heures Je vais me contenter d'un compromis et essayer de traiter un éventail d'idées en trois vidéos 
        Cela ne sera pas exhaustif mais j'espère que cela donnera un aperçu convenable d'où je viens. 
    """
